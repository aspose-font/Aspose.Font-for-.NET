...
namespace Aspose.Font.Examples.WorkingWithTrueTypeAndOpenTypeFonts
{
    class RenderingText
    {
        public static void Run()
        {
            ...
            DrawText("Hello world", ttfFont, 14, Brushes.White, Brushes.Black, dataDir+"hello1_out.jpg");

            DrawText("Hello world", ttfFont, 14, Brushes.Yellow, Brushes.Red, dataDir+"hello2_out.jpg");
        }
                    ...
                    Brush backgroundBrush, Brush textBrush, string outFile)
        {
            ...
            foreach (GlyphId gid in gids)
            {
                ...
                if (gid != null)
                {
                    ...
                    Aspose.Font.Matrix glyphMatrix =
                        new Aspose.Font.Matrix(
                            new double[]
                                    {
